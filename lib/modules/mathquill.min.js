...
!function () {
    ...
    function e(t) {
        var e = t.length - 1;
        return function () {
            var n = kt.call(arguments, 0, e), i = kt.call(arguments, e);
    ...
    function c(e) {
        ...
        s = {}, n.L = Tt, n.R = Ct, n.config = function (t) {
            ...
            e.__mathquillify = function () {
                ...
                var n;
                for (e = e.replace(/^\s+|\s+$/g, "").split(/\s+/), n = 0; n < e.length; n += 1) this.__controller.keystroke(e[n], {preventDefault: t});
                return this
            }, e.typedText = function (t) {
                for (var e = 0; e < t.length; e += 1) this.__controller.typedText(t.charAt(e));
                return this
            }, e.dropEmbedded = function (t, e, n) {
                var i, s = t - Dt(window).scrollLeft(), r = e - Dt(window).scrollTop(),
    ...
    function h(t, e, n) {
        return Qt(D, {ctrlSeq: t, htmlTemplate: "<" + e + " " + n + ">&0</" + e + ">"})
    }
    ...
    function d(t, e) {
        var e = e || t, n = pt[t], s = pt[e];
        At[t] = i(ft, Tt, t, n, e, s), At[n] = i(ft, Ct, t, n, e, s)
    }

    var m, g, b, v, w, q, x, y, O, k, j, Q, T, C, D, _, S, L, E, A, R, I, z, M, B, F, $, N, P, U, W, H, G, K, Y, X, Z,
        V, J, tt, et, nt, it, st, rt, ot, at, lt, ct, ut, ht, ft, pt, dt, mt, gt, bt, vt, wt = window.jQuery,
        qt = "mathquill-command-id", xt = "mathquill-block-id", yt = Math.min, Ot = Math.max, kt = [].slice,
        jt = e(function (t, n) {
        ...
        }("prototype", {}.hasOwnProperty), Tt = -1, Ct = 1, Dt = Qt(wt, function (t) {
            ...
            t.init = function (t, e) {
                ...
                var t = this.parent.parent, e = t.parent, n = t[Ct], i = this, s = t[Tt];
                ...
                var t, e = this.anticursor = _t.copy(this), n = e.ancestors = {};
    ...
    l.prototype = $t.p, l.interfaceVersion = function (t) {
        ...
        return function (n, i) {
            ...
            return w.bind("keydown keypress input keyup focusout paste", function (t) {
                q(t)
            }), m = !1, w.bind({keydown: l, keypress: c, focusout: h, paste: f}), {select: r}
        }
        ...
        function e(t, e) {
            var n = t.notify("upDown").cursor, i = e + "Into", s = e + "OutOf";
        ...
        var n = w.string, i = w.regex, s = w.letter, r = w.any, o = w.optWhitespace, a = w.succeed, l = w.fail,
            c = s.map(function (t) {
                return I(t)
            ...
            }), f = h.or(c).or(u), p = n("{").then(function () {
                return m
            }).skip(n("}")), d = o.then(p.or(f.map(t))), m = d.many().map(e).skip(o), g = n("[").then(d.then(function (t) {
                return "]" !== t.join("latex") ? a(t) : l()
            }).many().map(e).skip(o)).skip(n("]")), b = m;
        ...
        e.delegateMouseEvents = function () {
            ...
            this.container.bind("mousedown.mathquill", function (n) {
                ...
                var o, a = Dt(n.target).closest(".mq-root-block"), l = St.byId[a.attr(xt) || e.attr(xt)],
                    c = l.controller, u = c.cursor, h = u.blink, f = c.textareaSpan, p = c.textarea;
        ...
        t.scrollHoriz = function () {
            ...
            if (o) if (n = o.jQ[0].getBoundingClientRect(), i = n.left - (a.left + 20), s = n.right - (a.right - 20), o.ends[Tt] === r[Ct]) if (0 > i) e = i; else {
                if (!(s > 0)) return;
        ...
        Bt.p.substituteTextarea = function () {
            ...
            var t, e = this.textareaSpan = Dt('<span class="mq-textarea"></span>'),
            ...
            var e = this, n = (e.root, e.cursor), i = e.textarea, s = e.textareaSpan;
            ...
            var t = this, e = (t.root, t.cursor), n = t.textarea, i = t.textareaSpan, s = q(n, this);
        ...
        t.init = function (t, n, i) {
            ...
            var t, e, n, i = this, r = i.blocks, o = " mathquill-command-id=" + i.id,
            ...
            for (s("no unmatched angle brackets", a.join("") === this.htmlTemplate), t = 0, e = a[0]; e; t += 1, e = a[t]) if ("/>" === e.slice(-2)) a[t] = e.slice(0, -2) + o + "/>"; else if ("<" === e.charAt(0)) {
                ...
                do t += 1,
                    e = a[t], s("no missing close tags", e), "</" === e.slice(0, 2) ? n -= 1 : "<" === e.charAt(0) && "/>" !== e.slice(-2) && (n += 1); while (n > 0)
            }
        ...
        t.ctrlSeq = "\\text", t.replaces = function (t) {
            ...
            var t = this, e = w.string, n = w.regex, i = w.optWhitespace;
    ...
    }),Bt.p.autoCommands = {_maxLength: 0},Ft.autoCommands = function (t) {
        var e, n, i, s, r;
        ...
        t.init = function (t) {
            ...
            var n, i, s, r = t.options.autoCommands, o = r._maxLength;
            if (o > 0) {
            ...
            var e, i, s, r, o, a, l, c, u, h, f, p = t.autoOperatorNames;
            if (0 !== p._maxLength) {
    ...
    }),z = {},M = Bt.p.autoOperatorNames = {_maxLength: 9},B = {
        limsup: 1,
        liminf: 1,
        projlim: 1,
        injlim: 1
    ...
    tt ? Y = function (t, e, n) {
        ...
        t.supsub = "sub",
            t.htmlTemplate = '<span class="mq-supsub mq-non-leaf"><span class="mq-sub">&0</span><span style="display:inline-block;width:0">&#8203;</span></span>', t.textTemplate = ["_"], t.finalizeTree = function () {
        ...
        t.parser = function () {
            var t = w.regex, e = w.string, n = (w.succeed, w.optWhitespace);
            return n.then(t(/^(?:[([|]|\\\{)/)).then(function (i) {
                ...
                return x.then(function (r) {
                    return e("\\right").skip(n).then(t(/^(?:[\])|]|\\\})/)).map(function (t) {
                        var e = "\\" === t.charAt(0) ? t.slice(1) : t, n = ft(0, s, e, i, t);
        ...
        t.ctrlSeq = "\\MathQuillMathField", t.htmlTemplate = '<span class="mq-editable-field"><span class="mq-root-block">&0</span></span>', t.parser = function () {
            var t = this, n = w.string, i = w.regex, s = w.succeed;
